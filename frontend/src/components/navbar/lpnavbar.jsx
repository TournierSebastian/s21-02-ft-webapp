    ...
    <nav className="w-full bg-gray-800">
      <div className="w-full px-6 py-4">
        <div className="flex justify-between items-center">
          <div>
            <button className=" text-white font-medium fill-white hover:text-gray-500 hover:fill-gray-500 transition duration-500">
            <svg viewBox="0 0 60 60" id="Capa_1" version="1.1">
                  <g>
          ...
          <div className="space-x-4">
            <button className="bg-white text-black font-medium px-4 py-2 rounded-md hover:bg-gray-300 hover:text-gray-900 transition duration-500">
              Iniciar Sesión
            </button>
            <button className="bg-white text-black font-medium px-4 py-2 rounded-md hover:bg-gray-300 hover:text-gray-900 transition duration-500">
              Registrarse
